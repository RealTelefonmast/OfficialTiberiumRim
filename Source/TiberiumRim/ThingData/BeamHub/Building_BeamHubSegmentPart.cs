...
{
    private bool active;
    private List<Building_BeamHub> connectingHubs = new(4) { null, null, null, null };
    ...
    {
        get { return junction ??= (Building_BeamHub)Position.GetFirstThing(Map, parentHubDef); }
    }
    ...
    public bool HasNSConnection =>
        connectingHubs[0] != null && connectingHubs[2] != null; //.IsConnectedTo(connectingHubs[2], 2);
