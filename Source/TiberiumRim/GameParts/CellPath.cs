...
public class CellPath : IExposable
{
    ...
    private readonly List<IntVec3> pathCells = new();
    ...
    public CellPath(Map map, IntVec3 origin, IntVec3 puller, IntVec3 pusher, float pathLength,
        Predicate<IntVec3> validator, Predicate<IntVec3> endCondition, Action<IntVec3> processor = null)
    {
        this.map = map;
        this.origin = origin;
        this.puller = puller;
    ...
    private IntVec3 WeightedCellFor(IEnumerable<IntVec3> cells)
    {
        ...
        cells.TryRandomElementByWeight(delegate(IntVec3 t) { return pusher.DistanceTo(t) - min; }, out var cell);
        return cell;
    }
