...
namespace TiberiumRim
{
    ...
    {
        private EVASignal signal;

        public List<SoundDef> general;
        public List<SoundDef> optional;
    }
    ...
    public class GameComponent_EVA : GameComponent
    {
        ...
        public bool CanPlay => SelectedEVA != EVA.None && TRUtils.Tiberium().GameSettings.EVASystem;
