...
namespace TR.Networks
{
    public class TiberiumContainer : NetworkContainer<TiberiumValueType>
    {
        ...
        public TiberiumContainer(IContainerHolder<TiberiumValueType> parent) : base(parent)
        {
        }

        public TiberiumContainer(IContainerHolder<TiberiumValueType> parent, float capacity) : base(parent, capacity)
        {
        }

        public TiberiumContainer(IContainerHolder<TiberiumValueType> parent, float capacity, List<TiberiumValueType> acceptedTypes) : base(parent, capacity, acceptedTypes)
        {
        }
