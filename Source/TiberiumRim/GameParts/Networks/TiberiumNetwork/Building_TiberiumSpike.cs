...
public class Building_TiberiumSpike : FXBuilding
{
    ...
    public INetworkPart TibComponent => CompTNW[Defs.TiberiumDefOf.TiberiumNetwork];
    ...
    public override void SpawnSetup(Map map, bool respawningAfterLoad)
    {
        ...
        boundGeyser = this.Position.GetFirstThing(map, Defs.TiberiumDefOf.TiberiumGeyser) as Building_TiberiumGeyser;
