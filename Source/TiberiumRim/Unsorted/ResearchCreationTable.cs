...
{
    private readonly Dictionary<ThingDef, List<CreationOption>> creationOptionMap = new();
    private readonly Dictionary<CreationOption, int> thingsToCreate = new();
    ...
    public void AddCreation(Thing thing)
    {
        ...
        foreach (var option in options)
            if (option.quality == null || (thing.TryGetQuality(out var qc) && qc == option.quality))
