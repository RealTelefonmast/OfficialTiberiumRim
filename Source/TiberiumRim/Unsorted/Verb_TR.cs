...
public class Verb_TR : Verb
{
    ...
    public override void WarmupComplete()
    {
        ...
        if (Props.tiberiumCostPerBurst != null) Props.tiberiumCostPerBurst.Pay(TiberiumComp.Container);
    }
    ...
    public override bool Available()
    {
        ...
        if (Props.tiberiumCostPerBurst != null) return Props.tiberiumCostPerBurst.CanPay(TiberiumComp.Container);
        if (Props.tiberiumCostPerShot != null) return Props.tiberiumCostPerShot.CanPay(TiberiumComp.Container);
        if (CasterIsPawn)
        {
