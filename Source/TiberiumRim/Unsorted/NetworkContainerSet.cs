...
public class NetworkContainerSet<T> where T : Enum
{
    ...
    public HashSet<NetworkContainer<T>> ConsumerContainers = new();
    private T containerType;

    public HashSet<NetworkContainer<T>> FullSet = new();
    public HashSet<NetworkContainer<T>> ProducerContainers = new();
    public HashSet<NetworkContainer<T>> StorageContainers = new();
