...
public class TRMats
{
    ...
    public static readonly Texture2D DarkGreyBG =
    ...
    public static readonly Texture2D mutationVisceral =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(155, 160, 75).ToColor);

    public static readonly Texture2D mutationGreen =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(175, 255, 0).ToColor);

    public static readonly Texture2D mutationBlue =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(138, 229, 226).ToColor);
    ...
    public static readonly Texture2D
        blue = SolidColorMaterials.NewSolidColorTexture(new ColorInt(38, 169, 224).ToColor);

    public static readonly Texture2D yellow =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(249, 236, 49).ToColor);
    ...
    public static readonly Texture2D green =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(41, 180, 115).ToColor);

    public static readonly Texture2D white =
        SolidColorMaterials.NewSolidColorTexture(new ColorInt(255, 255, 255).ToColor);
