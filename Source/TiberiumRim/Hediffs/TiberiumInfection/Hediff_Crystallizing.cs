...
public class Hediff_Crystallizing : HediffWithComps
{
    ...
    public override float SummaryHealthPercentImpact => Part.def.hitPoints / (75f * pawn.HealthScale);
    ...
    public bool Reversing => pawn.health.hediffSet.HasHediff(TRHediffDefOf.TiberiumImmunity) ||
