...
namespace TiberiumRim
{
    ...
    public static class TRHediffDefOf
    {
        //
        //Cybernetics
        public static HediffDef RegenerativeNanites;
        public static HediffDef AugmentedEye;

        //Weapon Implants
        public static HediffDef CannonImplant;
        ...
        //Tiberium Affect
        public static HediffDef TiberiumToxemia;
        public static HediffDef TiberiumExposure;

        public static HediffDef CrystallizingPart;
        ...
        public static HediffDef ViscousBloat;
