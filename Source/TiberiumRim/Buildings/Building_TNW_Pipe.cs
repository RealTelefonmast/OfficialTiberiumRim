...
public class TNW_Pipe : FXBuilding
{
    ...
    public override void Draw()
    {
        ...
        if (CompTNW.Network != null)
        {
            ...
            TiberiumContent.TiberiumNetworkPipesGlow.ColoredVersion(ShaderDatabase.MoteGlow, color, color)
...
public class TNW_PipeDynamic : FXBuilding, IContainerHolder
{
    ...
    private float cachedPercent;
    public TiberiumContainer Container;
    private bool debugProduce;

    public List<TNW_PipeDynamic> Neighbors = new() { null, null, null, null };
    ...
    public override void Tick()
    {
        ...
        if (Container.TotalStorage >= 0.25f)
            for (var i = 0; i < 4; i++)
            {
                ...
                if (neighbor != null && neighbor.WantsFrom(this)) Give(ThroughPut(neighbor), neighbor);
            }
    }
    ...
    {
        from.Container.TryTransferTo(Container, TiberiumValueType.Green, value);
        cachedPercent = Container.StoredPercent;
    }
    ...
    {
        var str = "Smallest ThroughPut: " + smallest + "\n" + "Biggest Throughput: " + biggest;
        return str;
