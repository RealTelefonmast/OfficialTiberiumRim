...
public class Building_TiberiumGeyser : TRBuilding
{
    ...
    //
    private readonly int burstTicksLeft = -1;
    private double depositValue;

    //Values
    private float maxDepositValue;
    ...
    public override void SpawnSetup(Map map, bool respawningAfterLoad)
    {
        ...
        tibSprayer = new IntermittenFleckSprayer(this, delegate
        {
            ...
            if (Find.TickManager.TicksGame % 20 == 0)
            {
                ...
                map.GetMapInfo<AtmosphericMapInfo>()
                    .TrySpawnGasAt(cell, SpreadingGasDefOf.TiberiumGas, Rand.Range(500, 1000));
            }
        }, StartSpray, EndSpray);
