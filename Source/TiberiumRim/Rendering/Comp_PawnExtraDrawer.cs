        ...
        if (head != null && !headStump && ShouldShow(headRot, mirrored))
        {
            ...
            if (material != null)
            {
                ...
                var mesh2 = ShouldMirror(headRot, mirrored)
                    ...
                    : MeshPool.humanlikeHeadSet.MeshAt(headRot);
        ...
        foreach (var graphicPair in graphicData)
        {
            ...
            */
            ...
            if (!pawn.def.race.Humanlike)
                ...
                DrawOntoHuman(pawn, head, body, drawPos, rotation, renderBody, bodyFacing, bodyFacing,
                    flags.FlagSet(PawnRenderFlags.Portrait), flags.FlagSet(PawnRenderFlags.HeadStump), drawMirrored);
        }
    }
