...
namespace TiberiumRim
{
    ...
    public class CompFX : ThingComp
    {
        ...
        public override void PostSpawnSetup(bool respawningAfterLoad)
        {
            ...
            //IParent.FXComp = this;
            //iParent.TotalLayers = Props.overlays.Count(o => !o.skip);
        ...
        {
            GraphicColors = new Color[Overlays.Count];
        ...
        public override void PostDraw()
        {
            ...
            for (int i = 0; i < Overlays.Count; i++)
            {
                //Log.Message($"Drawing {i}: CanDraw: {CanDraw(i)} ({DrawBool(i)} & {OpacityFloat(i)} & {HasPower(i)}) DrawPos: {DrawPosition(i)} Color: {ColorOverride(i)} RotSpeed: {RotationOverride(i)} AnimSpeed: {AnimationSpeed(i)}");
