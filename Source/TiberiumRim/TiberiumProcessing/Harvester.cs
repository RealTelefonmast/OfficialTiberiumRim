...
public class Harvester : MechanicalPawn, IContainerHolder
{
    ...
    //Priority Bools
    private bool ShouldIdle => Container.Empty &&
                               (!HasAvailableTiberium ||
                                (Container.TotalStorage > 0 && RefineryComp.Container.CapacityFull));

    private bool ShouldHarvest =>
        !ContainerFull && HasAvailableTiberium; //CurrentPriority == HarvesterPriority.Harvest;
    ...
    public override void Kill(DamageInfo? dinfo, Hediff exactCulprit = null)
    {
        ...
        if (Container.TotalStorage > 0)
        {
            ...
            var damage = (int)(10 * Container.StoredPercent);
