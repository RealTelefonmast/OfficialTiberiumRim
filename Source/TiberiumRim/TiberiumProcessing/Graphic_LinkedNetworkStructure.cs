...
namespace TiberiumRim
{
    public class Graphic_LinkedNetworkStructure : Graphic_Linked
    {
        ...
        {
            return c.InBounds(parent.Map) && parent.Map.Tiberium().NetworkInfo.HasConnectionAtFor(parent, c); //parent.Map.GetComponent<MapComponent_TNWManager>().ConnectionAt(c);
        }
        ...
        public override void Print(SectionLayer layer, Thing thing, float extraRotation)
        {
            ...
            foreach (var pos in comp.ConnectionCells)
            {
