...
{
    [Unsaved] private string cachedTaskInfo;
    ...
    public List<RecipeDef> recipeUnlocks = new();
    public StatDef relevantPawnStat;
    public StatDef relevantTargetStat;
    public List<ThingDef> requiredFacilities;
    public List<ThingDef> requiredThings = new();
    public List<SkillRequirement> skillRequirements;
    public TargetProperties taskTarget;
    public List<TRThingDef> unlocks = new();
    ...
    public TResearchDef ParentProject
    {
        get
        {
            return parentProject ??=
                DefDatabase<TResearchDef>.AllDefsListForReading.FirstOrDefault(r => r.tasks.Contains(this));
        }
    }
    ...
    public virtual float ProgressReal => creationTasks != null
        ? TRUtils.ResearchManager().CreationTable.TaskCompletion(this)
        : TRUtils.ResearchManager().GetProgress(this);
