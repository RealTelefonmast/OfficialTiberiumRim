...
public class TiberiumConversionRulesetDef : Def
{
    ...
    public void GetOutcomes(IntVec3 pos, Map map, out TerrainDef top, out TerrainDef under,
        out TiberiumCrystalDef crystalDef)
    {
        under = null;
        GenTiberium.GetTerrain(map, out TerrainDef topTerrain, out TerrainDef underTerrain);

        GetOutcomes(topTerrain, out top, out crystalDef, out var isTop);
