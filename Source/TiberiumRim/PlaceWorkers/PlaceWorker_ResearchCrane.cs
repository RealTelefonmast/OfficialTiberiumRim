...
public class PlaceWorker_ResearchCrane : PlaceWorker
{
    ...
    private IEnumerable<Thing> ResearchTargets =>
        TargetDefs.SelectMany(t => Find.CurrentMap.listerThings.ThingsOfDef(t));
    ...
    {
        pos = loc;
        return Overlaps(TargetAt(loc), CellRectAt(loc)) ? true : "TR_OnTiberiumProducer".Translate();
    }
