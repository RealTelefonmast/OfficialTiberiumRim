...
namespace TiberiumRim
{
    ...
    {
        private CompTNW_Crafter billStackOwner;
        private List<CustomTiberiumBill> bills = new List<CustomTiberiumBill>();
        ...
        public TiberiumBillStack(CompTNW_Crafter parent)
        {
        ...
        public CompTNW_Crafter ParntComp => billStackOwner;
