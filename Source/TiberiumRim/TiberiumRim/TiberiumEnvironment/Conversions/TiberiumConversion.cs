...
namespace TiberiumRim
{
    ...
    public class TiberiumConversion2
    {
        public TerrainFilterDef terrainFilter;
        //public ThingOptionsDef toCrystal;
        //public TerrainOptionsDef toTerrain;

        public List<WeightedThing> toCrystal;
        public List<TerrainOption> toTerrain;
        ...
        {
            crystalDef = (TiberiumCrystalDef) toCrystal.RandomElementByWeight(t => t.weight).thing;
            var terrainOption = toTerrain.RandomElementByWeight(t => t.weight);
            terrainDef = terrainOption.terrainDef;
            isTopLayer = terrainOption.isTopLayer;
        }

        // Soil -> TiberiumSoilGreen , TiberiumGreen
        ...
        */
        ...
        public bool HasOutcomesFor(TerrainDef def)
        {
            return terrainFilter.Allows(def);
        }
    }
}
