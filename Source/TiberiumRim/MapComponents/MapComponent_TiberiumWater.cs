...
public class MapComponent_TiberiumWater : MapComponent, ICellBoolGiver
{
    ...
    public readonly HashSet<IntVec3> LandableCells = new();
    public readonly HashSet<IntVec3> RiverCells = new();
    public readonly HashSet<IntVec3> WaterCells = new();
    ...
    public override void MapGenerated()
    {
        ...
        LandableCells.AddRange(map.AllCells.Where(c =>
            RiverCells.Any(r => r.DistanceTo(c) is var f && f >= 4 && f <= 10)));
