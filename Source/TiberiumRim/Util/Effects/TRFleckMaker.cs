...
public static class TRFleckMaker
{
    public static void ThrowTiberiumAirPuff(Vector3 loc, Map map)
    {
        ...
        var dataStatic =
            FleckMaker.GetDataStatic(loc + new Vector3(Rand.Range(-0.02f, 0.02f), 0f, Rand.Range(-0.02f, 0.02f)), map,
                EffectsDefOf.TiberiumAirPuff, 1.5f);
    ...
    public static void ThrowTiberiumSmoke(Vector3 loc, Map map, float size)
    {
        ...
        var dataStatic = FleckMaker.GetDataStatic(loc, map, EffectsDefOf.TiberiumSmoke, Rand.Range(1.5f, 2.5f) * size);
    ...
    public static void ThrowTiberiumLeak(Vector3 loc, Map map, Rot4 rotation, Color color)
    {
        ...
        var dataStatic = FleckMaker.GetDataStatic(loc, map, EffectsDefOf.TiberiumSmoke, 0.55f);
