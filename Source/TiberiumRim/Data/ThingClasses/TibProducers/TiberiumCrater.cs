...
namespace TR.Data.ThingClasses.TibProducers;
...
public class TiberiumCrater : TiberiumProducer, IResearchCraneTarget, IGroundZero
{
    ...
    public override string GetInspectString()
    {
        ...
        if (DebugSettings.godMode) sb.AppendLine("ShouldSpawnSpore: " + ShouldSpawnSpore);
    ...
    public override IEnumerable<Gizmo> GetGizmos()
    {
        ...
        if (!TiberiumTypes.EnumerableNullOrEmpty())
            yield return new Command_Action
            {
                ...
                action = delegate { areaMutator.CreateBlossom(); }
            };
