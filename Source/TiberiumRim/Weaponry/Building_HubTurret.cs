...
public class Building_HubTurret : Building_TRTurret
{
    ...
    public override Vector3[] DrawPositions => new[]
        { DrawPos, DrawPos, DrawPos, MainGun.top.barrels[0].DrawPos, MainGun.top.barrels[1].DrawPos };

    public override float?[] RotationOverrides => new[]
        { null, null, MainGun?.TurretRotation, MainGun?.TurretRotation, MainGun?.TurretRotation };
