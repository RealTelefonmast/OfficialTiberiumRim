...
public class Comp_ExtraTurret : ThingComp, ITurretHolder
{
    ...
    public ThingWithComps Caster => parent;
    ...
    public override void PostSpawnSetup(bool respawningAfterLoad)
    {
        ...
        foreach (var props in (props as CompProperties_ExtraTurret).turrets)
        {
    ...
    {
        base.CompTick();
        foreach (var turret in turrets) turret.TurretTick(false);
    }

    public override void PostDraw()
    {
        base.PostDraw();
        foreach (var turret in turrets) turret.Draw();
    }
}
