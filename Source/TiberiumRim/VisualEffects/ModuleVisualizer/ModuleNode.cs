...
namespace TiberiumRim
{
    public abstract class ModuleNode
    {
        ...
        {
            if(IOData.ConnectsTo(ModuleVisualizer.Vis.FinalOutput))
                ModuleVisualizer.Vis.Notify_DataChanged();
        }

        public void Notify_TryConnectAt(NodeAnchor fromAnchor, Vector2 lineEnd)
        {
            ModuleVisualizer.Vis.TryConnectModuleToOther(this, fromAnchor, lineEnd);
        }
