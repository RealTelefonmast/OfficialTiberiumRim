...
{
    public static Dictionary<TResearchTaskDef, List<Thing>> targets = new();
    private static readonly Dictionary<ThingDef, List<TResearchTaskDef>> tasksForThings = new();
    ...
    private static bool Available(Thing thing)
    {
        ...
        return compThing.IsPowered(out var usesPower) || !usesPower;
    }
}