...
namespace TiberiumRim
{
    public class NodeAnchor
    {
        ...
        private Vector2 Size => new Vector2(ModuleVisualizer.AnchorHeight, ModuleVisualizer.AnchorHeight);
        ...
        private void DoAnchorControl()
        {
            ...
            if (Mouse.IsOver(anchorRect))
            {
                if (evType == EventType.MouseDown)
                {
                    //Start connecting
                    AnchorPulled = true;
                    ModuleVisualizer.Vis.MakingNewConnection = true;
                }
            }
            ...
            if (evType == EventType.MouseUp && curEv.button == 0)
            {
                ...
                currentLineEnd = null;
                AnchorPulled = false;
                ModuleVisualizer.Vis.MakingNewConnection = false;
            }
        }
