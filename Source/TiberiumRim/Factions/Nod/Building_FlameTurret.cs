...
public class Building_FlameTurret : Building_HubTurret
    {
        ...
        public override void Draw()
        {
            ...
            if (settingFireWall)
            {
                GenDraw.DrawFieldEdges(CellGen.SectorCells(UnityEngine.UIElements.Position, Map, Range, 90f, (DrawPos.AngleToFlat(UI.MouseMapPosition()) + 90).AngleWrapped(), false).ToList());
            }
            ...
            yield return new Command_Action
            {
                ...
                action = delegate
                {
                    ...
                    delegate (LocalTargetInfo target)
                    {
                        ...
                        var from = UnityEngine.UIElements.Position;
                        var to = target.Cell;
                        ...
                        fireWallPos = to;
                        distanceVector = (fireWallPos.Cell - UnityEngine.UIElements.Position).ToVector3Shifted();
...
/* OLD REF (pre-reorganization, namespace TR)
using System.Collections.Generic;
using System.Linq;
using System.Text;
using RimWorld;
