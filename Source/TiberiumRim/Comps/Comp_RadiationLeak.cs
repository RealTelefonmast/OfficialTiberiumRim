...
public class Comp_RadiationLeak : ThingComp_TiberiumRadiation, IRadiationSource
{
    ...
    public override void PostPostApplyDamage(DamageInfo dinfo, float totalDamageDealt)
    {
        ...
        if (ShouldLeakWhenDamaged && !parent.DestroyedOrNull() &&
            (float)parent.HitPoints / parent.MaxHitPoints <= Props.leakDamageThreshold) TryStartRadiating();
    }
}