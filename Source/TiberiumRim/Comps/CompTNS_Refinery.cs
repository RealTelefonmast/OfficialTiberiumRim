...
public class CompTNS_Refinery : Comp_TiberiumNetworkStructure
{
    ...
    public Designator_ZoneAdd_HarvestTiberium ZoneDesignator =>
        zoneDesignator ??= new Designator_ZoneAdd_HarvestTiberium(this);
    ...
    {
        var harvester = (Harvester)MechComp.MakeMech(Props.harvester);
    ...
    public override IEnumerable<Gizmo> CompGetGizmosExtra()
    {
        ...
        */
        ...
        yield return new Command_Target
        {
            ...
            {
                if (target.HasThing && target.Thing is Data.ThingClasses.TibProducers.TiberiumProducer producer)
                {
                    var newZone = new Zone_HarvestTiberium(parent.Map.zoneManager);
                    newZone.ParentRefinery = this;
                    producer.FieldCells.ForEach(c => newZone.AddCell(c));
                    HarvestTiberiumZone = newZone;
                }
            }
        };
