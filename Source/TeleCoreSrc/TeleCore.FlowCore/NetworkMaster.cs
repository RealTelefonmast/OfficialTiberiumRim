...
namespace TeleCore
{
    public class NetworkMasterObsolete
    {
        private Map map;
        ...
        public NetworkMasterObsolete(Map map, NetworkDef networkDef)
        {
            this.map = map;
        ...
        public Network RegenerateNetwork(INetworkComponent root, out HashSet<Network> oldNets)
        {
            ...
            NetworkObsolete newNet = new NetworkObsolete(root.NetworkDef, map, this);
