...
public class ClampWorker_Overcommit : ClampWorker
{
    ...
    public override DefValueStack<FlowVolumeConfig<>.Values.NetworkValueDef, float> ClampFunction(FlowInterface<NetworkPart, NetworkVolume, FlowVolumeConfig<>.Values.NetworkValueDef> iface, DefValueStack<FlowVolumeConfig<>.Values.NetworkValueDef, float> f, ClampType type)
    {
        var from = iface.From;
        var to = iface.To;
