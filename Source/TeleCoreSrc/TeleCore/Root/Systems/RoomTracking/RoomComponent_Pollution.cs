...
namespace TeleCore.Systems.RoomTracking
{
    public class RoomComponent_Pollution : RoomComponent
    {
        ...
        public override void Notify_RoofClosed()
        {
            ...
            pollutionContainer.RegenerateData(Group.CellCount);
        }
        ...
        {
            return Mathf.RoundToInt((10000f * (pressureA - pressureB)) / (8f * (float)System.Math.PI * length));
        }
        ...
        public override void OnGUI()
        {
            if (Find.CameraDriver.CurrentZoom == CameraZoomRange.Closest)
            {
                ...
                GenMapUI.DrawThingLabel(v, Group.ID + "[" + Pollution + "]{" + UsedContainer.TotalCapacity + "}", Color.red);
            }
            //vectorField.OnGUI();
        }
