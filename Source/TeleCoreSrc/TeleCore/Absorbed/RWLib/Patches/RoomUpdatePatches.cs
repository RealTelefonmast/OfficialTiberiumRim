...
using TeleCore.Systems.RoomTracking.Updates;
...
internal static class RoomUpdatePatches
{
    ...
    private static Room GetParentRoom(Thing thing, Verse.Map map)
    {
    ...
    {
        public static bool Prefix(Verse.Map ___map)
        {
    ...
    {
        public static bool Prefix(Verse.Map ___map, List<Room> ___newRooms, HashSet<Room> ___reusedOldRooms)
        {
    ...
    {
        public static void Postfix(Thing thing, Verse.Map map)
        {
    ...
    {
        public static void Postfix(IntVec3 c, Region reg, Verse.Map ___map)
        {
    ...
    {
        public static void Postfix(IntVec3 c, Verse.Map ___map)
        {
    ...
    {
        public static void Postfix(Room r, Verse.Map ___map)
        {
