...
namespace TeleCore.Rendering.TextureContent;
...
public class TiberiumContent
{
    ...
    public static readonly Texture2D AttentionMarker = ContentFinder<Texture2D>.Get("UI/Icons/AttentionMarker");
    public static readonly Texture2D NewMarker = ContentFinder<Texture2D>.Get("UI/Icons/NewMarker");
    ...
    public static readonly Texture2D Construct = ContentFinder<Texture2D>.Get("UI/Icons/Construct");

    public static readonly Texture2D SelectThing = ContentFinder<Texture2D>.Get("UI/Icons/SelectThing");
    ...
    public static readonly Material Infested_1 =
        MaterialPool.MatFrom("World/Tile/Tib_1", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material Infested_2 =
        MaterialPool.MatFrom("World/Tile/Tib_2", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material Infested_3 =
        MaterialPool.MatFrom("World/Tile/Tib_3", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material Infested_4 =
        MaterialPool.MatFrom("World/Tile/Tib_4", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material TibTile_1 =
        MaterialPool.MatFrom("World/Old/Tib_1", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material TibTile_2 =
        MaterialPool.MatFrom("World/Old/Tib_2", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material TibTile_3 =
        MaterialPool.MatFrom("World/Old/Tib_3", ShaderDatabase.WorldOverlayTransparentLit, 3505);

    public static readonly Material TibTile_4 =
        MaterialPool.MatFrom("World/Old/Tib_4", ShaderDatabase.WorldOverlayTransparentLit, 3505);
    ...
    public static readonly Texture2D Hediff_Radiation = ContentFinder<Texture2D>.Get("UI/Icons/Hediffs/Radiation");
    public static readonly Texture2D Hediff_Immunity = ContentFinder<Texture2D>.Get("UI/Icons/Hediffs/Immunity");
