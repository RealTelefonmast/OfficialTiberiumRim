...
public partial struct ImmutableArray<T> : IEquatable<ImmutableArray<T>>, IImmutableArray
{
    ...
    public static readonly ImmutableArray<T> Empty = new(new T[0]);

    public static ImmutableArray<T> DefaultInit => new(new T[1]);
    ...
    {
        return obj is IImmutableArray other && array == other.Array;
    }
