    ...
    where TDef : FlowValueDef
{
    ...
    public static implicit operator bool(FlowResultStack<TDef> result)
    {
        return result.State != FlowState.Failed;
    }
    ...
    where TValue : unmanaged
{
    ...
    public static implicit operator bool(FlowResult<TDef, TValue> result)
    {
        return result.State != FlowState.Failed;
    }
