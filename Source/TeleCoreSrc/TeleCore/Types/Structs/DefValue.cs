    ...
    where TValue : unmanaged
{
    ...
    public static implicit operator DefValue<TDef, TValue>((TDef Def, Numeric<TValue> Value) value)
    {
        return new DefValue<TDef, TValue>(value.Def, value.Value);
    }

    public static implicit operator TDef(DefValue<TDef, TValue> def)
    {
        return def.Def;
    }

    public static explicit operator Numeric<TValue>(DefValue<TDef, TValue> def)
    {
        return def.Value;
    }
