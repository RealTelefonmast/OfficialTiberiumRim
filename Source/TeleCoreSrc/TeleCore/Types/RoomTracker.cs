...
public class RoomTracker
{
    ...
    private readonly HashSet<Room> borderRooms = new();
    ...
    public RoomTracker(Room room)
    {
        ...
        RoomNeighbors = new RoomNeighborSet();
    ...
    public RoomNeighborSet RoomNeighbors { get; } = new();
    ...
    internal void DrawDebug()
    {
        ...
        foreach (var comp in Comps) comp.DrawDebug();
    ...
    private void RegenerateRoomRelations()
    {
        foreach (var room in borderRooms)
        {
            ...
            RoomNeighbors.Notify_AddNeighbor(otherTracker);
        }
    }
    ...
    private void RegenerateListerThings()
    {
        ...
        for (var r = 0; r < Room.Regions.Count; r++)
        {
            ...
            foreach (var pawn in pawns) Notify_PawnEnteredRoom((Pawn)pawn);
        }
        ...
        foreach (var cell in borderCells)
        {
            ...
            foreach (var thing in things) Notify_RegisterBorderThing(thing);
        }
        ...
        foreach (var c in Room.Cells)
        {
            ...
            for (var i = 0; i < 4; i++)
            {
                ...
                if (cardinal.InBounds(Map))
                {
                    ...
                    if (noReg || unsameRoom)
                    {
                        if (unsameRoom) borderRooms.Add(region.Room);
    ...
    public RoomTrackerLink SelfTrackerLink { get; private set; }
    ...
    public void Init(RoomTracker?[] previous)
    {
        ...
        //
        RegenerateData();
        foreach (var comp in Comps) comp.InternalInit(previous);
    }
    ...
    {
        foreach (var comp in Comps) comp.Notify_PawnEnteredRoom(pawn);
    }
    ...
    public void Notify_RegisterBorderThing(Thing thing)
    {
        ...
        foreach (var comp in Comps) comp.Notify_HandleBorderThing(thing);
    ...
    private void HandleAttachedNghb(Thing thing)
    {
        if (thing is Building b)
        {
            ...
            RoomNeighbors.Notify_AddAttachedNeighbor(otherTracker);
        }
    }
