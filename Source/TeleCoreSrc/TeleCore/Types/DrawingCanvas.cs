...
public class DrawingCanvas
{
    ...
    {
        var compute = DrawShader;
        var texture = WorkingTex; //A render texture that we feed into the compute shader
        ...
        if (mouseDown) compute.SetVector("_MousePos", mouseNormalized);
