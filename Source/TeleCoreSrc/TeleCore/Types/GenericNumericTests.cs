...
public class GenericNumericTests
{
    ...
    {
        var num = Numeric<int>.Zero;
        var num2 = Numeric<int>.One;
        var num3 = Numeric<int>.NegativeOne;

        Assert.AreEqual(num.Value, 0);
        Assert.AreEqual(num2.Value, 1);
        Assert.AreEqual(num3.Value, -1);

        var fNum = Numeric<float>.Zero;
        var fNum2 = Numeric<float>.One;
        var fNum3 = Numeric<float>.NegativeOne;
        var fNum4 = Numeric<float>.Epsilon;
        ...
        var dNum = Numeric<double>.Zero;
        var dNum2 = Numeric<double>.One;
        var dNum3 = Numeric<double>.NegativeOne;
        var dNum4 = Numeric<double>.Epsilon;
    ...
    public void RoundTest()
    {
        ...
        Assert.AreEqual(num2Round, Math.Round(5.4999f, 2));
        Assert.AreEqual(num3Round, Math.Round(5.4999, 2));
    }
