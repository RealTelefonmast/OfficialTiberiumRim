...
{
    private static readonly Dictionary<UIElement, HashSet<UIElement>> References = new();
    private static readonly Dictionary<UIElement, UIElement> ReferencesReverse = new();
