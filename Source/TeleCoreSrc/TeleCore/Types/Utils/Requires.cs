...
internal static class Requires
{
    ...
    /// <summary>
    ///     Throws an exception if the specified parameter's value is null.  It passes through the specified value back as a
    ///     return value.
    /// </summary>
    /// <typeparam name="T">The type of the parameter.</typeparam>
    /// <param name="value">The value of the argument.</param>
    ...
    {
        if (null == value) FailArgumentNullException(parameterName);
    }
    ...
    {
        if (string.IsNullOrEmpty(message)) throw new ArgumentOutOfRangeException(parameterName);
