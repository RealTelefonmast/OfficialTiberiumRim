...
public static class FlagUtils
{
    ...
    public static unsafe T And<T>(this T first, T second) where T : unmanaged, Enum
    {
        ...
        {
            case 8:
                var temp8 = BitwiseUtils.And(*(ulong*)&first, *(ulong*)&second);
                return *(T*)&temp8;
            case 4:
                var temp4 = BitwiseUtils.And(*(uint*)&first, *(uint*)&second);
                return *(T*)&temp4;
            case 2:
                var temp2 = BitwiseUtils.And(*(ushort*)&first, *(ushort*)&second);
                return *(T*)&temp2;
            case 1:
                var temp1 = BitwiseUtils.And(*(byte*)&first, *(byte*)&second);
                return *(T*)&temp1;
            default:
    ...
    public static unsafe T Or<T>(this T first, T second) where T : unmanaged, Enum
    {
        ...
        {
            case 8:
                var temp8 = BitwiseUtils.Or(*(ulong*)&first, *(ulong*)&second);
                return *(T*)&temp8;
            case 4:
                var temp4 = BitwiseUtils.Or(*(uint*)&first, *(uint*)&second);
                return *(T*)&temp4;
            case 2:
                var temp2 = BitwiseUtils.Or(*(ushort*)&first, *(ushort*)&second);
                return *(T*)&temp2;
            case 1:
                var temp1 = BitwiseUtils.Or(*(byte*)&first, *(byte*)&second);
                return *(T*)&temp1;
            default:
                throw new NotSupportedException($"Unsupported enum size: {sizeof(T)} bytes");
        }
    ...
    public static unsafe T Xor<T>(this T first, T second) where T : unmanaged, Enum
    {
        ...
        {
            case 8:
                var temp8 = BitwiseUtils.Xor(*(ulong*)&first, *(ulong*)&second);
                return *(T*)&temp8;
            case 4:
                var temp4 = BitwiseUtils.Xor(*(uint*)&first, *(uint*)&second);
                return *(T*)&temp4;
            case 2:
                var temp2 = BitwiseUtils.Xor(*(ushort*)&first, *(ushort*)&second);
                return *(T*)&temp2;
            case 1:
                var temp1 = BitwiseUtils.Xor(*(byte*)&first, *(byte*)&second);
                return *(T*)&temp1;
            default:
                throw new NotSupportedException($"Unsupported enum size: {sizeof(T)} bytes");
        }
    ...
    public static unsafe T Not<T>(this T value) where T : unmanaged, Enum
    {
        ...
        {
            case 8:
                var temp8 = BitwiseUtils.Not(*(ulong*)&value);
                return *(T*)&temp8;
            case 4:
                var temp4 = BitwiseUtils.Not(*(uint*)&value);
                return *(T*)&temp4;
            case 2:
                var temp2 = BitwiseUtils.Not(*(ushort*)&value);
                return *(T*)&temp2;
            case 1:
                var temp1 = BitwiseUtils.Not(*(byte*)&value);
                return *(T*)&temp1;
            default:
                throw new NotSupportedException($"Unsupported enum size: {sizeof(T)} bytes");
        }
...
public static class BitwiseUtils
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool HasBit(byte value, byte flag)
    {
        return (value & flag) != 0;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Is(byte first, byte second)
    {
        return (first & second) == second;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNot(byte first, byte second)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotZero(byte value)
    {
        return value != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ushort And(ushort first, ushort second)
    {
        return (ushort)(first & second);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ushort Or(ushort first, ushort second)
    {
        return (ushort)(first | second);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ushort Xor(ushort first, ushort second)
    {
        return (ushort)(first ^ second);
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ushort Not(ushort value)
    {
        return (ushort)~value;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool HasBit(ushort value, ushort flag)
    {
        return (value & flag) != 0;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Is(ushort first, ushort second)
    {
        return (first & second) == second;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNot(ushort first, ushort second)
    {
        return (first & ~second) != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotZero(ushort value)
    {
        return value != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static uint Xor(uint first, uint second)
    {
        return first ^ second;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool HasBit(uint value, uint flag)
    {
        return (value & flag) != 0;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Is(uint first, uint second)
    {
        return (first & second) == second;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNot(uint first, uint second)
    {
        return (first & ~second) != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotZero(uint value)
    {
        return value != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ulong Xor(ulong first, ulong second)
    {
        return first ^ second;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool HasBit(ulong value, ulong flag)
    {
        return (value & flag) != 0;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Is(ulong first, ulong second)
    {
        return (first & second) == second;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNot(ulong first, ulong second)
    {
        return (first & ~second) != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotZero(ulong value)
    {
        return value != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool Is(int first, int second)
    {
        return (first & second) == second;
    }

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNot(int first, int second)
    {
        return (first & ~second) != 0;
    }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool IsNotZero(int value)
    {
        return value != 0;
    }
