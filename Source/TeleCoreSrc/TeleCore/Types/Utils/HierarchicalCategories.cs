...
{
    private static readonly Dictionary<HierarchicalCategoryDef, IList<HierarchicalCategoryDef>> _hierarchyMap;
    private static readonly Dictionary<HierarchicalCategoryDef, IList<HierarchicalCategoryDef>> _kindMap;
