...
{
    public static int RegisteredComponentTypes;
    private static readonly ComponentType[] _componentTypes = new ComponentType[1024]; // Adjust size as needed
    private readonly int _archetypeCapacity;
    private readonly ArchetypeStorage* _archetypeStorages;
    ...
    {
        var type = typeof(T);
        for (var i = 0; i < RegisteredComponentTypes; i++)
    ...
    public void Dispose()
    {
        for (var i = 0; i < _archetypeCount; i++) _archetypeStorages[i].Dispose();
