...
internal static class ThingEvent_Patches
{
    ...
    public static class Thing_DeSpawnPatch
    {
        ...
        public static void Postfix(Thing __instance)
        {
            GlobalEventHandler.Things.OnDespawned(new ThingStateChangedEventArgs(ThingChangeFlag.Despawned,
                __instance));
        }
    }
    ...
    public static class Thing_DiscardPatch
    {
        public static void Postfix(Thing __instance)
        {
            GlobalEventHandler.Things.OnDiscarded(new ThingStateChangedEventArgs(ThingChangeFlag.Discarded,
                __instance));
        }
    }
    ...
    public static class ThingWithComps_BroadcastCompSignalPatch
    {
        ...
        {
            //Event Handling
            GlobalEventHandler.Things.OnSentSignal(new ThingStateChangedEventArgs(ThingChangeFlag.SentSignal,
                __instance, signal));
        }
    }
