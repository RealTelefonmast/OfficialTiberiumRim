...
public class TurretGunSet : IExposable
{
    ...
    {
        foreach (var turret in Turrets) turret.TickGun();
    }
    ...
    public void DoAttackNow(LocalTargetInfo targ, int turretIndex)
    {
        ...
        foreach (var turret in Turrets) turret.ForceOrderAttack(targ);
    }

    public void ClearAttack()
    {
        foreach (var turret in Turrets) turret.ResetCurrentTarget();
    }
}