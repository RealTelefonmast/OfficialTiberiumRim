    ...
    where TVolume : FlowVolumeBase<TValueDef>
{
    ...
    public TVolume From { get; }
    public TVolume To { get; }
    public InterfaceFlowMode Mode { get; }
    ...
    {
        return
            $"{From.FillPercent:P2} =[{Mode}][{PassPercent:P2}]=> {To.FillPercent:P2} (Prev: {PrevFlow} Next: {NextFlow})";
