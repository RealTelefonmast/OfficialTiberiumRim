...
{
    public override AcceptanceReport AllowsPlacing(BuildableDef def, IntVec3 loc, Rot4 rot, Verse.Map map, Thing thingToIgnore = null, Thing thing = null)
    {
    ...
    private bool Blocked(IntVec3 pos, Verse.Map map)
    {
        var thing = pos.GetFirstThing<Building>(map);
        return thing != null && thing.def.IsEdifice();
    }

    private bool HasDuplicate(IntVec3 pos, Verse.Map map, BuildableDef def)
    {
