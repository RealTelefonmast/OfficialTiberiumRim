...
public abstract class WeatherOverlay_TiberiumPollution : SkyOverlay
{
    private static readonly Material ParticleOverlay = MatLoader.LoadMat("Weather/SnowOverlayWorld");
    private static readonly Material FoggyOverlay = MatLoader.LoadMat("Weather/FogOverlayWorld");

    private Material overlayCopy;

    public WeatherOverlay_TiberiumPollution()
    {
        MainMat = new Material(ParticleOverlay.shader);
        MainMat.CopyPropertiesFromMaterial(ParticleOverlay);
