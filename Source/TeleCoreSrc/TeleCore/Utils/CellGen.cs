...
{
    public static IEnumerable<IntVec3> SectorCells_Old(IntVec3 center, Verse.Map map, float radius, float angle,
    ...
    public static IEnumerable<IntVec3> SectorCells(IntVec3 center, Verse.Map map, float radius, float desiredAngle,
    ...
    public static IEnumerable<IntVec3> PointsOnLineOfSightWithHeight(Vector3 start, Vector3 end, float maxHeight)
    {
        ...
        if (TeleCore.TMath.Abs(start.x - end.x) < 0.015625)
