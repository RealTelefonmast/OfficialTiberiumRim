...
public abstract class RoomComponent
{
    ...
    public RoomCompNeighborSet CompNeighbors { get; private set; }
    ...
    {
        Parent = parent;
        CompNeighbors = new RoomCompNeighborSet();
    }
    ...
    {
        CompNeighbors.Notify_AddLink(link);
    }

    internal void Notify_AddNeighbor<T>(T neighbor) where T : RoomComponent
    {
        CompNeighbors.Notify_AddNeighbor(neighbor);
    }
