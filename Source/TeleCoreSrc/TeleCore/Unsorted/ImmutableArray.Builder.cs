...
public partial struct ImmutableArray<T>
{
    ...
    public sealed class Builder : IList<T>, IReadOnlyList<T>
    {
        ...
        public void Insert(int index, T item)
        {
            ...
            if (index < this.Count)
            {
                System.Array.Copy(_elements, index, _elements, index + 1, this.Count - index);
            }
        ...
        public void InsertRange(int index, IEnumerable<T> items)
        {
            ...
            if (index != this.Count)
            {
                System.Array.Copy(_elements, index, _elements, index + count, _count - index);
            }
        ...
        public void RemoveAt(int index)
        {
            ...
            {
                System.Array.Copy(_elements, index + 1, _elements, index, this.Count - index - 1);
            }
...
#endif
                System.Array.Copy(_elements, index + length, _elements, index, this.Count - index - length);
            }
        ...
        public T[] ToArray()
        {
            ...
            System.Array.Copy(_elements, result, this.Count);
            return result;
        }
        ...
        public void CopyTo(T[] array, int index)
        {
            ...
            System.Array.Copy(_elements, 0, array, index, this.Count);
        }
        ...
        public void CopyTo(T[] destination)
        {
            ...
            System.Array.Copy(_elements, 0, destination, 0, this.Count);
        }
        ...
        public void Sort()
        {
            if (Count > 1)
            {
                System.Array.Sort(_elements, 0, this.Count, Comparer<T>.Default);
            }
        }
