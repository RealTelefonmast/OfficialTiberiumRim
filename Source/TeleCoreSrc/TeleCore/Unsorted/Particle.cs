...
public class Particle2 : IParticle, IExposable
{
    ...
    public virtual void PreSpawn(Verse.Map map, IntVec3 cell)
    {
    }

    public virtual void Spawn(Verse.Map map)
    {
    }
...
public class Particle : Verse.Entity, IExposable
{
    ...
    public virtual void PreSpawnSetup(IntVec3 spawnCell, Verse.Map map)
    {
        this.map = map;
    ...
    public override void SpawnSetup(Verse.Map map, bool respawning)
    {
