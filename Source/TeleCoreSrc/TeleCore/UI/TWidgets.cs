...
public static partial class TWidgets
{
    ...
    {
        var point1 = new Vector3(cellWidth, 0, 0);
        var point2 = Vector3.zero;
        var point1_screen = Find.Camera.WorldToScreenPoint(point1) / Prefs.UIScale;
        var point2_screen = Find.Camera.WorldToScreenPoint(point2) / Prefs.UIScale;
        var pixelWidth = (point1_screen - point2_screen).magnitude;
        return pixelWidth;
    }
    ...
    {
        var v = thing.TrueCenter().ToScreenPos();
