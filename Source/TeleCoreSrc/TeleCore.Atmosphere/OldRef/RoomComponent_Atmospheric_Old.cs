...
namespace TeleCore.Atmosphere.OldRef
{
    ...
    public class RoomComponent_Atmospheric_Old : RoomComponent, IContainerHolderRoom<TAE.AtmosphericDef>, IContainerImplementer<TAE.AtmosphericDef, IContainerHolderRoom<TAE.AtmosphericDef>, TAE.AtmosphericContainer>
    {
        //
        ...
        public bool Notify_SpradingGasDissipating(TAE.SpreadingGasTypeDef def, int dissipatedAmount, out ValueResult<TAE.AtmosphericDef> actual)
        {
